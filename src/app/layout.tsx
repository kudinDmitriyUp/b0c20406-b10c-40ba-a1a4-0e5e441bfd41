...
export const metadata: Metadata = {
  title: "Luxury Car Rental | Premium Vehicles | Luxury Motors",
  description: "Experience premium luxury car rentals with white-glove service. Choose from our curated fleet of Mercedes, BMW, Audi, and Bentley vehicles.",
  keywords: "luxury car rental, premium vehicles, high-end car hire, executive transportation, luxury auto rentals",
  metadataBase: new URL("https://luxurymotors.com"),
  alternates: {
    canonical: "https://luxurymotors.com"
  },
  openGraph: {
    title: "Luxury Car Rental | Premium Vehicles | Luxury Motors",
    description: "Experience premium luxury car rentals with white-glove service. Choose from our curated fleet of Mercedes, BMW, Audi, and Bentley vehicles.",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765046340393-w1fprgo9.jpg",
        alt: "Luxury Motors - Premium Car Fleet"
      }
    ]
  },
  twitter: {
    ...
    title: "Luxury Car Rental | Premium Vehicles | Luxury Motors",
    description: "Experience premium luxury car rentals with white-glove service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765046340393-w1fprgo9.jpg"]
  },
  robots: {
    index: true,
    follow: true
